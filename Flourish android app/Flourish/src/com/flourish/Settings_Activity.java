...
public class Settings_Activity extends BaseTimeOutActivity {
	...
	SharedPreferences mSharedPreferences;
		...
		mProPayEmail_EditText=(EditText)findViewById(R.id.propay_email_et);
		mTaxRate_TextView=(TextView)findViewById(R.id.tax_rate_tv);
		mAlwaysDeliverInvoices_btn=(Button)findViewById(R.id.AlwaysDeliverInvoices_tbtn);
		mTaxShipping_btn=(Button)findViewById(R.id.Tax_Shaipping_tbtn_settings);
		
		
		mSettingBackButton=(Button)findViewById(R.id.SettinsTopbarBack_Btn);
		mSaveSettingButton=(Button)findViewById(R.id.settingTopbarSave_settings_Btn);
		...
		if (mAppNetwork.isNetworkAvailable(Settings_Activity.this)) 
		{
			new getUserSettingAsynkTask().execute();
		}
		else 
		{
			mAppNetwork.getAlertDialog(Settings_Activity.this, getResources().getString(R.string.alert_dialog_no_network));
		}
	...
	View.OnClickListener buttonClickListener=new View.OnClickListener() {
		...
		public void onClick(View v) {
			...
			case R.id.SettinsTopbarBack_Btn:
				startActivity(new Intent(Settings_Activity.this, FlourishHomeActivity.class));
	...
	class getUserSettingAsynkTask extends AsyncTask<Void, Void, Void>
	{
		...
		protected void onPreExecute() {
			FlourishProgressDialog.ShowProgressDialog(Settings_Activity.this);
			super.onPreExecute();
	...
	mResponse=mConnectionManager.setUpHttpGet(mTaskUrl+mSessionId);
		...
		protected void onPostExecute(Void result) {
			...
			FlourishProgressDialog.Dismiss(Settings_Activity.this);
	...
	public void saveUserSettings()
	{
		...
		saveSettingJsonObject.put("ProPayEmail", mProPayEmail_EditText.toString().trim());
